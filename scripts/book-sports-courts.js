...
document.addEventListener('DOMContentLoaded', function() {
   function showPaymentdetail(event) {
       ...
       if (fragmentParams.has('method') && fragmentParams.get('method') === 'momo' && checkBox.checked) {
           var momoform = document.getElementById('momo-form');
           momoform.classList.add('active');
           overlay.style.display = 'block';
       } else if (fragmentParams.has('method') && fragmentParams.get('method') === 'bank' && checkBox.checked) {
