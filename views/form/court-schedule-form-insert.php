    <!-- FORM THÊM LỊCH SÂN -->
    <form id="form-insert" action="court-schedule-controller.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-body-content">
          ...
          <div class="form-row">
            ...
            <div class="input" style="pointer-events: none;">
              <!-- <textarea id="demo" name="court_schedule_id" placeholder="Mã lịch sân"></textarea> -->
