    <!-- Admin cancel reason (receive court order) -->
    <?php
    ...
    <form id="form-admin-cancel-reason-receive" action="./sport-court-orders-management.php" method="post" enctype="multipart/form-data">
      ...
      <div class="ad-can-rea-rec-body">
        ...
        <div class="reason">
          <label>
            <input type="radio" name="cancel_reason" value="Khách hàng không đến nhận sân">
            &nbsp;&nbsp;&nbsp;Khách hàng không đến nhận sân
          </label>
        </div>
      </div>
      <div class="ad-can-rea-rec-footer">
        <div class="ad-can-rea-rec-btn-gr">
    ...
    <style>
      #form-admin-cancel-reason-receive {
        display: flex;
        width: 387px;
        padding: 10px 30px;
      ...
      .ad-can-rea-rec-btn-gr a:hover {
        background: #dae0e2;
      }

      .ad-can-rea-rec-btn-gr a p {
        color: #5e6a6e;
        text-align: center;
        font-size: 14px;
        font-style: normal;
      ...
      #form-admin-cancel-reason-receive input[type="submit"] {
        display: flex;
        padding: 4px 15px;
        justify-content: center;
        align-items: center;
      ...
      #form-admin-cancel-reason-receive input[type="submit"]:hover {
        cursor: pointer;
