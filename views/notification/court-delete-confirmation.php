...
<div class="delete-confirm-container">
        <div class="main-content">
          <img src="../image/sport-courts-management-img/delete-confirm.svg" alt="delete confirm icon">
          <div class="content">
        ...
        <div class="action">
          <a id="del-con-act-no" href="./sport-courts-management.php">Không</a>
          <a 
            id="del-con-act-yes" 
            href="<?php 
                    if(isset($_GET['court_id'])) {
                        $court_id = urlencode($_GET['court_id']);
                      echo "?option=delete_court&court_id=".$court_id;
                    }
                  ?>
          ">Có
          </a>
