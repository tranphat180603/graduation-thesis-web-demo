...
<div class="delete-confirm-container">
        <div class="main-content">
          <img src="../image/event-management-img/delete-confirm.svg" alt="delete confirm icon">
          <div class="content">
        ...
        <div class="action">
          <a id="del-con-act-no" href="./event-management.php">Không</a>
          <a 
            id="del-con-act-yes" 
            href="<?php 
                    if(isset($_GET['event_id'])) {
                        $event_id = urlencode($_GET['event_id']);
                      echo "?option=delete_event&event_id=".$event_id;
                    }
                  ?>
          ">Có
          </a>
