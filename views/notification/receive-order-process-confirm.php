      <!-- Order Process Confirmation (receive) -->
      <div class="order-confirm-container">
        <div class="main-content">
          <img id="order-confirm-icon" src="../image/sport-court-orders-management-img/receive.svg" alt="order confirm icon">
          <div class="content">
            <p id="order-confirm-question">Bạn thật sự muốn xử lý đơn đặt sân này?</p>
            <p id="order-confirm-explanation">Đơn đặt sân này sẽ được chuyển trạng thái thành <span id="order-confirm-state">HOÀN THÀNH</span> nếu bạn xử lý nó.</p>
          </div>
        </div>
        <div class="action">
          ...
          <a 
            ...
            href="<?php 
                    if(isset($_GET['court_order_id'])) {
                      ...
                      echo "?option=process_receive_court_order&court_order_id=" . $court_order_id;
                    }
                  ?>
          ">Có
          </a>
