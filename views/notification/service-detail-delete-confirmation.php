      <!-- Service Detail Delete Confirmation -->
      <div class="delete-confirm-container">
        <div class="main-content">
          <img src="../image/sport-court-schedules-management-img/confirm.svg" alt="delete confirm icon">
          <div class="content">
            <p id="delete-confirm-question">Số lượng hiện tại của dịch vụ mà bạn muốn thực hiện giảm số lượng là 1!</p>
            <p id="delete-confirm-explanation">Nếu bạn muốn xóa dịch vụ này, hãy chọn Có.</p>
          </div>
        </div>
        <div class="action">
          ...
          <a 
            ...
            href="<?php 
                    if(isset($_GET['cart_id']) && isset($_GET['court_schedule_id']) && isset($_GET['service_id'])) {
                      ...
                      echo "?option=delete_service_detail&cart_id=".$cart_id."&court_schedule_id=".$court_schedule_id."&service_id=".$service_id;
                    }
                  ?>
          ">Có
          </a>
