      ...
      <div class="warning-container">
        <div class="main-content">
          <img id="warning-icon" src="/LP-Sport-Center//image/sport-court-schedules-management-img/confirm.svg" alt="warning icon">
          <div class="content">
        ...
        <div class="action">
          <a id="war-act-ok" href="/LP-Sport-Center/views/sport-court-schedules-management.php">OK</a>
        </div>
      </div>
      <style>
        .warning-container {
